  ...
  return (
    <div>
      <div className="bg-white p-2">
        <h3 className="p-1">{t("Database Connection")}</h3>
        {/* table section */}
        <Table responsive>
          <thead>
            <tr className="bg-danger">
              <th scope="col" style={{ color: " rgba(51, 48, 60, 0.87)" }}>
                {t("SYSTEM NAME")}
              </th>
              <th scope="col" style={{ color: " rgba(51, 48, 60, 0.87)" }}>
                {t("DETAILS")}
      ...
      <div className="text-center ">
        <div className="mt-3">
          <span
            ...
            style={{ backgroundColor: "rgba(168, 170, 174, 0.16)" }}
          >
            {t("Question")}
          </span>
        </div>
        <div className="mt-2">
          <h2>{t("Facing any issue? Contact us")}</h2>
        </div>
        <div className="mt-2">
          <span>
            Lorem ipsum dolor sit ant sapiente consequatur veritatis asperiores
            similique explicabo.
          </span>
        </div>
      </div>
