...
import { Button, Card, CardBody, Col, Label, Modal, ModalBody, ModalHeader, Row, Badge,CardHeader,CardTitle,Form ,Input,ButtonGroup} from "reactstrap";
...
<Link
    ...
    <Modal 
          ...
          <CardTitle tag='h4' className="" style={{color:" rgba(77, 75, 85, 1)", fontWeight:"600"}}> Form Submission</CardTitle>
        </CardHeader>
        
              <Row tag='form' onSubmit={handleSubmit(onSubmit)}>
             <p>Are You Sure You Want to  Form Submission ?</p>
